...
int main ()
{
  ...
  **/
  ...
  PID pid_throttle = PID();
  	...
  	//NOTE: You can change this taus'
  	pid_steer.Init(0.29, 0.001, 0.7, 1.2, -1.2);
  
  	//NOTE: First maxi then mini
  ...
  h.onMessage([&pid_steer, &pid_throttle, &new_delta_time, &timer, &prev_timer, &i, &prev_timer](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode)
  {
        ...
        if (s != "") {
          ...
          **/
          	...
          	//NOTE: I computed the steer error as the difference between current ego car's position and las y coordinate in desired trajectory.
          	// I chose y because I think the car is moving in the x direction forward and the y coordinate means lateral movement.
          ...
          **/
          ...
          //NOTE: I computed the error for throttle as the difference between actual velocity and desired velocity taken from las point in 
          // v_points vector. I think this way is going to give correct results for acceleration.
          ...
          **/
           ...
           if (throttle > 0.0) {
             ...
             //This is gonna make braking the car
             throttle_output = 0;
